...
public class AnfitrionAcitvity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anfitrion_acitvity);
        ...
        navView = findViewById(R.id.navview_anfitrion);
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.logout:
                                mAuth.signOut();
                                Intent intent = new Intent(AnfitrionAcitvity.this, LoginActivity.class);
