...
public class RnotificationService extends IntentService {
    FirebaseAuth mAuth;
    ...
    private void createNotificationChannel(Reserva reserva){
    ...
    private void createNotification(Reserva reserva){
        ...
        Intent intent2 = new Intent(this, MisAlojamientosFragment.class);
                ...
                for (DataSnapshot singleSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (mAuth.getCurrentUser()!=null){
                        ...
                        if (ireserva.getAlojamiento().getAnfitrion().getCorreo().equals(mAuth.getCurrentUser().getEmail())) {
                            ...
                            createNotificationChannel(ireserva);
                            createNotification(ireserva);
